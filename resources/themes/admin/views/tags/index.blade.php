...
<header class="header bg-light lter hidden-print bg-white box-shadow">
    ...
    <div class="pull-right toolbar-control" style="margin-top: 10px;">
        ...
        <button data-action="delete" class="btn btn-sm btn-danger" data-url="{{ route('admin.tags.destroy', 0) }}"><i class="icon icon-trash"></i> {{ __('admin::admin.delete') }}</button>
    </div>
</header>
    ...
    <section class="no-padder b-r" style="width: 400px; max-width: 400px;">
        <section class="vbox animated fadeInRight">
            <section class="scrollable wrapper hover w-f">
                <h4 class="font-thin">Add New Tag</h4>
                
                {!! Form::open(['route' => 'admin.tags.store', 'class' => 'normal']) !!}
...
$(function(){
    var tbl = $('#category-table').DataTable({
        ...
        columns: [
            ...
            { data: 'slug', name: 'slug' },
            { data: 'count', name: 'count', className: 'option' },
