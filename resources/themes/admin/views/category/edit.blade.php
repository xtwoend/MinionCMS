...
{!! Form::model($row, ['route' => ['admin.categories.update', $row->id], 'class' => 'full-height', 'method' => 'PUT']) !!}
...
<header class="header bg-light lter hidden-print bg-white box-shadow">
    ...
    <div class="pull-right toolbar-control" style="margin-top: 10px;">
        <a href="{{ route('admin.categories.index') }}"  class="btn btn-sm btn-info" data-bjax> <i class="fa fa-chevron-left"></i></a>
    ...
    <section class="no-padder b-r">
        <section class="vbox animated fadeInRight">
            <section class="scrollable wrapper hover w-f">
                <h4 class="font-thin">Edit   Category</h4>
