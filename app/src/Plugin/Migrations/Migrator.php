...
class Migrator
{
     ...
     * Create new instance.
     *
     * @param \Minion\Plugin\Plugin $plugin
     */
    public function __construct(Plugin $plugin)
    {
        $this->plugin = $plugin;
        $this->laravel = $plugin->getLaravel();
    }
    ...
    public function getPath()
    {
        ...
        $path = (is_array($config) && array_key_exists('path', $config)) ? $config['path'] : config('plugins.paths.generator.migration');
